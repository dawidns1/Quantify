                  ...
                  {detailsError ? (
                    ...
                    <div style={{
                      ...
                      <div style={{ flex: '1 1 320px', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
                        ...
                        <div style={{ flexGrow: 1, minHeight: '220px', background: 'rgba(0, 0, 0, 0.08)', border: '1px solid var(--panel-border)', borderRadius: '8px', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-around', padding: '1.5rem 1rem 0.75rem 1rem' }} className="pulse">
                    ...
                    <div style={{
                      ...
                      <div style={{ flex: '1 1 320px', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
                        ...
                        {(!selectedStockDetails.financials || selectedStockDetails.financials.length === 0) ? (
                          <div style={{ flexGrow: 1, minHeight: '220px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-muted)', fontSize: '0.78rem', background: 'rgba(0,0,0,0.1)', borderRadius: '8px', border: '1px solid var(--panel-border)' }}>
                            No past annual results available.
                          </div>
                        ) : (
                          <div style={{ flexGrow: 1, minHeight: '220px', position: 'relative', background: 'rgba(0, 0, 0, 0.12)', border: '1px solid var(--panel-border)', borderRadius: '8px', padding: '0.5rem' }}>
                            {financialsChartData && (
                              <Bar 
